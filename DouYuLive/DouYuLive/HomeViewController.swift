...
class HomeViewController: UIViewController {
    ...
    fileprivate lazy var titleView: PageTitleView = { [weak self] in
        ...
        let frame = CGRect(x: 0, y: 64, width: kScreenW, height: kTitleViewH)
    ...
    fileprivate lazy var contentView: PageContentView = { [weak self] in
        ...
        let contentView = PageContentView(frame: CGRect(x: 0, y: 64 + kTitleViewH, width: kScreenW, height: kScreenH - 64 - kTitleViewH - kTabBarH), childVCs: childVCs, parentVC: self)
